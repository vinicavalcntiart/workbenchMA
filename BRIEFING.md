...
1. **Follow-up sistemático.** Toda carta fria sem resposta em 7 dias recebe UM lembrete curto, no mesmo fio, enviado direto por `mcp__Gmail__reply` (não rascunho, não Apps Script), com `to` explícito e ZERO emoji. Texto padrão está em `automacao/processados.csv` (linha de 18/09, "follow-ups de 7 dias"). Roda na rodada do Comunicador das 11h05 UTC com a busca POR DATA: `in:sent subject:"Senior Character Artist" after:AAAA/MM/DD before:AAAA/MM/DD`, onde a primeira data e hoje menos 8 dias e a segunda hoje menos 6 dias. NAO usar `older_than:7d newer_than:8d`: medido em 21/09, essa consulta devolveu {} (vazio) para um lote de 41 fios que a janela por data achou no mesmo minuto. A busca devolve ate 50 fios por pagina; pagine se o resultCountEstimate passar disso. Só fio de UMA mensagem. Nunca para casa que recusou, pessoa que respondeu, fio com veto, casa na mão do Vini, ou fio que já tem lembrete. Nunca segundo lembrete. Primeira leva: 36 lembretes em 18/09, lotes de 08 e 09/09.
