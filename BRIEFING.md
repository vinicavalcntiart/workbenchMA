...
1. **Só rascunho.** Nunca enviar email por ele. Única exceção: a resposta-padrão de recusa, em thread já existente, feita pela rotina de monitoramento.
...
5. **Escopo geográfico:** América do Norte, Europa (incl. UK/Irlanda/Nórdicos), Oceania e, na Ásia, só Coreia do Sul e Singapura. **Japão está fora** (idioma, fuso, moeda). Não prospectar Índia nem Brasil. Exceção brasileira única: Estúdio Pé Grande.
...
## Calendário
- 02/09 07h30 UTC: onda de follow-up (~90 rascunhos nas threads existentes).
