# Trabalhos de Portfolio

Pasta dos projetos de portfólio em produção. Cada trabalho tem a sua própria
subpasta com o brief, o estado do pipeline, os planos de entrega e um diário.

Diferente da `Estudos Extras Curriculares/`, que guarda pesquisa e ferramenta,
aqui mora o que vira peça de portfólio. O PDF fechado continua em `portfolio/`.
