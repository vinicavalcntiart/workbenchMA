...
The *Subdivision Surface* modifier (often shortened as slang to "Subdiv" or "Subsurf")
...
.. note::
   ...
   This modifier uses
   the `OpenSubdiv library <https://opensubdiv.org/docs/intro.html>`__ as a backend.
