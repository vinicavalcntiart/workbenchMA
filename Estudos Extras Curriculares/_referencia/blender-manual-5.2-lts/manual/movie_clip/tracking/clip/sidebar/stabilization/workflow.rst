...
- Increase the lighting level, at least use a higher sensitivity.
  ...
  Inevitably, we're losing some quality through the interpolation necessary for stabilization.
  Plus we're losing some quality due to color space conversion.
