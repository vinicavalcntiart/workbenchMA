...
- **Sem travessão.** Sem floreio de IA, sem "I hope this finds you well".
- **EMOJI AGORA E OBRIGATORIO fora do formulario**, cobrado tres vezes pelo Vini. Preferencia dele: ☺️ e 😊. Resposta humana calorosa leva um ou dois; carta fria para pessoa, um; carta para caixa, um no fecho; campo de ATS, ZERO; recusa e follow-up de silencio, ZERO. Ver a regra completa no fim do BRIEFING.md.
