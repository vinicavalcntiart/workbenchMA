...
12. **Datas e horas em mensagem para aluno se contam no fuso DO ALUNO, nunca em UTC nem em
    Recife.** Ray Blair e Quin Burt estão no **Pacific Time (America/Los_Angeles)**. "Today",
    "tomorrow", "next Friday" e a hora da sessão são calculados em PT, e a hora vai escrita no
    fuso do aluno primeiro (ex.: "Friday, October 2 at 7:30am PT"). Recife só entra se ajudar,
    e entre parênteses. Erro de 24/09: e-mail ao Ray saiu com "today" porque o relógio da
    sessão do Claude está em UTC e já tinha virado o dia. Conferir o fuso do aluno antes de
    escrever qualquer data relativa. Aluno novo: descobrir o fuso na primeira troca e anotar
...
| 24/09/2026 | Ray Blair (Pacific Time) | saycebuckley2@yahoo.com | Sessão de 25/09 11:30 remarcada para 02/10 11:30 BRT (compromisso de trabalho imprevisto) | Evento movido no Agenda e e-mail enviado pelo Vini |
